...
from core.tool.tool_base import ToolBase
...
class Flux:
    def __init__(self,
                 ...
                 listeners: Optional[List[ListenerBase]] = None):
        """
        ...
        self.listeners: List[ListenerBase] = listeners if listeners else []
    ...
    def run(self, callback=None, tool_params: Optional[dict] = None):
        ...
        try:
            ...
            self.state = FluxState.COMPLETED
            end_time = time.time()
