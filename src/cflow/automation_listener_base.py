# src/cflow/automation_listener_base.py
import logging
from cflow.automation_listener_protocol import AutomationListenerProtocol

log = logging.getLogger("cflow")

class AutomationListener(AutomationListenerProtocol):
    """
