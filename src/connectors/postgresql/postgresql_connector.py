...
import psycopg2
from psycopg2 import OperationalError as Error, sql
from cflow.connector_base import ConnectorBase, NotifiableConnector
from cflow.logger import log


class PostgreSQLConnector(ConnectorBase, NotifiableConnector):
    def __init__(
            self,
        ...
        super().__init__(
            name=name,
            description=description or "Connector for PostgreSQL integration",
